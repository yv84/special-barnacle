...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(@me.yv84.specialbarnacle.studiousspoon.web.config.logging.LogTime * *(..))")
     ...
     */
    @Pointcut("within(me.yv84.specialbarnacle.studiousspoon.web.controller..*)")
